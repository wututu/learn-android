...
public abstract class RefreshLayout extends FrameLayout {
    ...
    public RefreshLayout(Context context, AttributeSet attrs) {
        ...
        mHeaderViewContainer = (RelativeLayout) mRefreshHeaderView.findViewById(R.id.header_container);
        ...
        mRefreshHeaderView.getViewTreeObserver().addOnGlobalLayoutListener(
                new ViewTreeObserver.OnGlobalLayoutListener() {
                    ...
                    public void onGlobalLayout() {
                        mHeaderViewHeight = mHeaderViewContainer.getHeight();
                        Log.d("wenhao", "mHeaderViewHeight = " + mHeaderViewHeight);
                        getViewTreeObserver()
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        switch (aciont) {
            case MotionEvent.ACTION_DOWN:
                mLastMotionY = mActionDownY = ev.getY();
                mIsBeingDragged = false;
                Log.d("wenhao", "MotionEvent.ACTION_DOWN");
                break;
            case MotionEvent.ACTION_MOVE:
                final float y = ev.getY();
                ...
                Log.d("wenhao", "MotionEvent.ACTION_MOVE " + mIsBeingDragged);
                break;
            ...
            case MotionEvent.ACTION_CANCEL:
                ...
                handleRelease();
                Log.d("wenhao", "MotionEvent.ACTION_UP");
                break;
            default:
                break;
        }
